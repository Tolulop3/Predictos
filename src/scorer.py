...
def apply_filters(market: dict, sentiment: dict, model_prob: float,
                  ml_confidence: float,
                  model_is_trained: bool = False) -> tuple[bool, list[str]]:
    """
    ...
    if model_is_trained:
        ...
        # Fallback: require 4% minimum edge
        # Achievable when sentiment score ≥ 0.65 (moderate-strong news backing)
        # Filters markets with no news signal while allowing news-backed picks through
...
def score_market(market: dict,
                 ...
                 model_is_trained: bool = False) -> dict:
    """
