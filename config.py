...
MAX_RESOLUTION_DAYS        = 180   # skip markets >180 days out (2028 elections etc)
MAX_RESOLUTION_DAYS_SPORTS = 45    # sports season markets: max 45 days
MIN_DAILY_VOLUME_USD       = 2_000 # lowered — many good markets trade $2-10k/day
GRAHAM_EDGE_THRESHOLD      = 0.06  # lowered to 6% — 8% was blocking too many
MIN_MARKET_PROB            = 0.06  # lowered to 6% — 8% cut too many real markets
MAX_MARKET_PROB            = 0.94  # raised slightly
NEWS_HALF_LIFE_DAYS        = 5
TREND_HALF_LIFE_DAYS       = 10
ML_CONFIDENCE_THRESHOLD    = 0.45  # lowered — fallback model is conservative by nature
