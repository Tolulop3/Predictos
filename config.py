...
# ML confidence
# Fallback model range: 0.34-0.57. Trained model: 0.40-0.90+.
# Hard block: below 0.38 means signals actively conflict (rare in fallback)
# Soft flag: below 0.55 means moderate confidence only — paper sizing only
ML_CONFIDENCE_THRESHOLD    = 0.55   # target: show HIGH/MEDIUM on dashboard
ML_MIN_CONFIDENCE_ENTRY    = 0.38   # hard block: signals conflict, do not enter
